...
struct GoodDeedView: View {
    ...
    var deedDescriptions = ["By 2030, ensure that all men and women, in particular the poor and the vulnerable, have equal rights to economic resources as well as access to basic services ownership and control over land and other forms of 13 property inheritance natural resources, appropriate new technology and financial services including micro finance", "By 2030, ensure sustainable food production systems and implement resilient agricultural practices that increase productivity and production, that help maintain ecosystems, that strengthen capacity for adaptation to climate change, extreme weather, drought, flooding and other disasters and that progressively improve land and soil quality","Desc A", "Desc B", "Desc C","Desc D", "Desc E", "Desc F","Desc G", "Desc H", "Desc I","Desc J", "Desc A", "Desc B", "Desc C","Desc D", "Desc E", "Desc F","Desc G", "Desc H", "Desc I","Desc J"]
...
var deedDescriptions = ["By 2030, ensure that all men and women, in particular the poor and the vulnerable, have equal rights to economic resources as well as access to basic services ownership and control over land and other forms of 13 property inheritance natural resources, appropriate new technology and financial services including micro finance", "By 2030, ensure sustainable food production systems and implement resilient agricultural practices that increase productivity and production, that help maintain ecosystems, that strengthen capacity for adaptation to climate change, extreme weather, drought, flooding and other disasters and that progressively improve land and soil quality", "Desc C","Desc D", "Desc E", "Desc F","Desc G", "Desc H", "Desc I","Desc J"]
